...
export default function ResetPassword() {
  ...
  const validatePassword = (pwd: string): { valid: boolean; message: string } => {
    if (pwd.length < 8) {
      return { valid: false, message: t("resetPassword.passwordTooShort") };
    }
    if (pwd.length > 32) {
      return { valid: false, message: t("resetPassword.passwordTooLong") };
    }
    if (!/\d/.test(pwd)) {
      return { valid: false, message: t("resetPassword.passwordNeedsDigit") };
    }
    if (!/[a-zA-Z]/.test(pwd)) {
      return { valid: false, message: t("resetPassword.passwordNeedsLetter") };
    }
        ...
        <div className="bg-zinc-900/80 backdrop-blur-sm rounded-lg border border-zinc-800 p-8 shadow-2xl">
          {isValidating ? (
            ...
            <div className="flex flex-col items-center justify-center py-8 space-y-4">
              ...
              <p className="text-zinc-400 text-sm">{t("resetPassword.validating") || "Validating..."}</p>
            </div>
          ) : isInvalidToken ? (
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className="bg-zinc-800 border-zinc-700 text-white placeholder:text-zinc-500 focus-visible:ring-zinc-600 pl-10 pr-10"
